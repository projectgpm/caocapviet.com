...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    ...
    <dx:ASPxGridView ID="gridDonDatHang" runat="server" AutoGenerateColumns="False" KeyFieldName="ID" Width="100%">
        ...
        <SettingsText CommandDelete="Xóa" CommandEdit="Sửa" CommandNew="Thêm" ConfirmDelete="Bạn có chắc chắn muốn xóa không?" PopupEditFormCaption="Thông tin đơn vị tính" Title="DANH SÁCH ĐƠN ĐẶT HÀNG ĐÃ DUYỆT" />
         <Columns>
             ...
             <dx:GridViewDataComboBoxColumn Caption="Kho Lập" FieldName="IDKhoLap" VisibleIndex="8">
             ...
             <dx:GridViewDataComboBoxColumn Caption="Kho Duyệt" FieldName="IDKhoDuyet" VisibleIndex="9">
                 <PropertiesComboBox DataSourceID="SqlKho" TextField="TenCuaHang" ValueField="ID">
                 </PropertiesComboBox>
             </dx:GridViewDataComboBoxColumn>
         </Columns>
