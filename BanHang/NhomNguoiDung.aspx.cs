...
namespace BanHang
{
    public partial class NhomNguoiDung : System.Web.UI.Page
    {
        ...
        protected void gridNhomNguoiDung_RowDeleting(object sender, DevExpress.Web.Data.ASPxDataDeletingEventArgs e)
        {
            ...
            LoadGrid();
            dtLichSuTruyCap.ThemLichSu(Session["IDNhanVien"].ToString(), Session["IDNhom"].ToString(), "Quản trị nhóm người dùng:" + ID, Session["IDKho"].ToString(), "Hệ Thống", "Xóa"); 
        }
        ...
        protected void gridNhomNguoiDung_RowUpdating(object sender, DevExpress.Web.Data.ASPxDataUpdatingEventArgs e)
        {
            ...
            gridNhomNguoiDung.CancelEdit();
            LoadGrid();
            dtLichSuTruyCap.ThemLichSu(Session["IDNhanVien"].ToString(), Session["IDNhom"].ToString(), "Quản trị nhóm người dùng:" + TenNhom, Session["IDKho"].ToString(), "Hệ Thống", "Cập Nhật"); 
        }
    }
}