...
namespace BanHang.Data
{
    public class dtThuMuaDatHang
    {
        ...
        public void CapNhatChiTietDonHang(string ID, int SoLuong)
        {
            using (SqlConnection myConnection = new SqlConnection(StaticContext.ConnectionString))
            {
                try
                {
                    myConnection.Open();
                    string cmdText = "UPDATE [GPM_ThuMua_DonHang_ChiTiet] SET [SoLuong] = @SoLuong,[ThanhTien] = [DonGia] * @SoLuong,[ThanhTien2] = [DonGia2] * @SoLuong  WHERE [ID] = @ID";
                    using (SqlCommand myCommand = new SqlCommand(cmdText, myConnection))
                    {
        ...
        public void ThemChiTietDonHang(object IDDonHangThuMua, string MaHang, string IDHangHoa, string IDDonViTinh, string TrongLuong, string SoLuong, string DonGia, string ThanhTien, string GhiChu,string DonGia2, string ThanhTien2)
        {
            using (SqlConnection myConnection = new SqlConnection(StaticContext.ConnectionString))
            {
                try
                {
                    myConnection.Open();
                    string cmdText = "INSERT INTO [GPM_ThuMua_DonHang_ChiTiet] ([IDDonHangThuMua],[MaHang],[IDHangHoa],[IDDonViTinh],[TrongLuong],[SoLuong],[DonGia],[ThanhTien],[GhiChu],[DonGia2],[ThanhTien2]) VALUES (@IDDonHangThuMua,@MaHang,@IDHangHoa,@IDDonViTinh,@TrongLuong,@SoLuong,@DonGia,@ThanhTien,@GhiChu,@DonGia2,@ThanhTien2)";
                    using (SqlCommand myCommand = new SqlCommand(cmdText, myConnection))
                    {
                        myCommand.Parameters.AddWithValue("@DonGia2", DonGia2);
                        myCommand.Parameters.AddWithValue("@ThanhTien2", ThanhTien2);
        ...
        public object ThemPhieuDatHang(string SoDonHang, string IDNguoiLap, DateTime NgayLap, string TongTrongLuong, string TongTien, string IDKhoLap, string GhiChu, string IDNhaCungCap, DateTime NgayDat, DateTime NgayGiaoDuKien, string ChietKhau, string TongTienSauChietKhau, string IDThanhToan, string TienChietKhau)
        {
            using (SqlConnection myConnection = new SqlConnection(StaticContext.ConnectionString))
            {
                try
                {
                    ...
                    string cmdText = "INSERT INTO [GPM_ThuMua_DonHang] ([NgayCapNhat],[SoDonHang],[IDNguoiLap],[NgayLap],[TongTrongLuong],[TongTien],[IDKhoLap],[GhiChu],[IDNhaCungCap],[NgayDat],[NgayGiaoDuKien],[ChietKhau],[TongTienSauChietKhau],[IDThanhToan],[TienChietKhau]) OUTPUT INSERTED.ID VALUES (getdate(),@SoDonHang,@IDNguoiLap,@NgayLap,@TongTrongLuong,@TongTien,@IDKhoLap,@GhiChu,@IDNhaCungCap,@NgayDat,@NgayGiaoDuKien,@ChietKhau,@TongTienSauChietKhau,@IDThanhToan,@TienChietKhau)";
                    using (SqlCommand myCommand = new SqlCommand(cmdText, myConnection))
                    {
                        myCommand.Parameters.AddWithValue("@TienChietKhau", TienChietKhau);
        ...
        public void CapNhatChiTietDonHang_temp(string IDDonHangThuMua, string IDHangHoa, int SoLuong, float DonGia, float ThanhTien, string GhiChu, string TrongLuong, float DonGia2, float ThanhTien2)
        {
            using (SqlConnection myConnection = new SqlConnection(StaticContext.ConnectionString))
            {
                try
                {
                    myConnection.Open();
                    string cmdText = "UPDATE [GPM_ThuMua_Temp] SET [TrongLuong] = @TrongLuong,[GhiChu] = @GhiChu,[SoLuong] = @SoLuong,[DonGia2] = @DonGia2,[ThanhTien2] = @ThanhTien2,[DonGia] = @DonGia,[ThanhTien] = @ThanhTien WHERE [IDHangHoa] = @IDHangHoa AND [IDDonHangThuMua] = @IDDonHangThuMua";
                    using (SqlCommand myCommand = new SqlCommand(cmdText, myConnection))
                    {
                        myCommand.Parameters.AddWithValue("@DonGia2", DonGia2);
                        myCommand.Parameters.AddWithValue("@ThanhTien2", ThanhTien2);
        ...
        public void ThemChiTietDonHang_Temp(string IDDonHangThuMua, string MaHang, string IDHangHoa, string IDDonViTinh, string TrongLuong, int SoLuong, float DonGia, float ThanhTien, string GhiChu, float DonGia2, float ThanhTien2)
        {
            using (SqlConnection myConnection = new SqlConnection(StaticContext.ConnectionString))
            {
                try
                {
                    myConnection.Open();
                    string cmdText = "INSERT INTO [GPM_ThuMua_Temp] ([IDDonHangThuMua],[MaHang],[IDHangHoa],[IDDonViTinh],[TrongLuong],[SoLuong],[DonGia],[ThanhTien],[GhiChu],[DonGia2],[ThanhTien2]) VALUES (@IDDonHangThuMua,@MaHang,@IDHangHoa,@IDDonViTinh,@TrongLuong,@SoLuong,@DonGia,@ThanhTien,@GhiChu,@DonGia2,@ThanhTien2)";
                    using (SqlCommand myCommand = new SqlCommand(cmdText, myConnection))
                    {
                        myCommand.Parameters.AddWithValue("@DonGia2", DonGia2);
                        myCommand.Parameters.AddWithValue("@ThanhTien2", ThanhTien2);
