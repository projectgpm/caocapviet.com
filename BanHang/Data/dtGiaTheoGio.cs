...
namespace BanHang.Data
{
    public class dtGiaTheoGio
    {
        ...
        public void ThemChiTiet(string MaHang, string IDHangHoa, string IDDonViTinh, string GiaBan,DateTime GioThayDoi, string IDKho, string IDNhanVien)
        {
            using (SqlConnection myConnection = new SqlConnection(StaticContext.ConnectionString))
            {
                ...
                {
                    myConnection.Open();
                    string cmdText = "INSERT INTO [GPM_GiaTheoGio] ([MaHang],[IDHangHoa],[IDDonViTinh],[GiaBan],[GioThayDoi],[IDKho],[IDNhanVien]) VALUES (@MaHang,@IDHangHoa,@IDDonViTinh,@GiaBan,@GioThayDoi,@IDKho,@IDNhanVien)";
        ...
        public void CapNhatChiTiet_Temp(string ID, string GiaBan, DateTime GioThayDoi)
        {
            using (SqlConnection myConnection = new SqlConnection(StaticContext.ConnectionString))
            {
                try
                {
                    myConnection.Open();
                    string cmdText = "UPDATE [GPM_GiaTheoGio_Temp] SET [GiaBan] = @GiaBan,[GioThayDoi] = @GioThayDoi WHERE [ID] = @ID";
                    using (SqlCommand myCommand = new SqlCommand(cmdText, myConnection))
                    {
                        myCommand.Parameters.AddWithValue("@GiaBan", GiaBan);
        ...
        public void ThemChiTiet_Temp(string IDTemp, string MaHang, string IDHangHoa, string IDDonViTinh, string GiaBan, DateTime GioThayDoi, string IDKho)
        {
            using (SqlConnection myConnection = new SqlConnection(StaticContext.ConnectionString))
            {
                try
                {
                    myConnection.Open();
                    string cmdText = "INSERT INTO [GPM_GiaTheoGio_Temp] ([IDTemp],[MaHang],[IDHangHoa],[IDDonViTinh],[GiaBan],[GioThayDoi],[IDKho]) VALUES (@IDTemp,@MaHang,@IDHangHoa,@IDDonViTinh,@GiaBan,@GioThayDoi,@IDKho)";
                    using (SqlCommand myCommand = new SqlCommand(cmdText, myConnection))
                    {
