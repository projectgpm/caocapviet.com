...
<body>
    ...
    <div>
      <dx:ASPxGridView runat="server" AutoGenerateColumns="False" Width="100%" ID="gridChiTiet" KeyFieldName="ID" OnRowUpdating="gridChiTiet_RowUpdating" OnRowInserting="gridChiTiet_RowInserting">
...
<Columns>
    ...
    <dx:GridViewCommandColumn Name="chucnang" ShowEditButton="True" VisibleIndex="9" ShowClearFilterButton="True" ShowNewButtonInHeader="True">
