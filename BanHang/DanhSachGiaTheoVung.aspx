...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
            ...
            <dx:LayoutItem Caption="">
                <LayoutItemNestedControlCollection>
                    <dx:LayoutItemNestedControlContainer runat="server">
                        <dx:ASPxButton ID="btnGiaTheoKho" runat="server" Text="Thay đổi giá theo kho - vùng" HorizontalAlign="Right" VerticalAlign="Middle" PostBackUrl="GiaTheoKho.aspx">
    ...
    <dx:ASPxGridView ID="gridHangHoa" runat="server" AutoGenerateColumns="False" KeyFieldName="ID" Width="100%" OnRowUpdating="gridHangHoa_RowUpdating">
        ...
        <Columns>
            ...
            <dx:GridViewDataSpinEditColumn Caption="Giá Bán" FieldName="GiaBanSauThue" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="3">
                <PropertiesSpinEdit DisplayFormatString="{0:#,# VND}" NumberFormat="Custom">
                </PropertiesSpinEdit>
            </dx:GridViewDataSpinEditColumn>
            <dx:GridViewDataSpinEditColumn Caption="Giá Bán Của Chi Nhánh" FieldName="GiaBan" ShowInCustomizationForm="True" VisibleIndex="4" Name="giaban">
                <PropertiesSpinEdit DisplayFormatString="{0:#,# VND}" NumberFormat="Custom">
                </PropertiesSpinEdit>
            </dx:GridViewDataSpinEditColumn>
    ...
    <asp:SqlDataSource ID="sqlKho" runat="server" ConnectionString="<%$ ConnectionStrings:BanHangConnectionString %>" SelectCommand="SELECT [ID], [TenCuaHang], [IDVung] FROM [GPM_Kho] WHERE ([DaXoa] = @DaXoa AND ID > 1) ">
        <SelectParameters>
