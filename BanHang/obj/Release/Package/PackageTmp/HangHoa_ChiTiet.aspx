    ...
    <div>
        ...
        <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" Width="100%">
            <Items>
                                ...
                                <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer15" runat="server">
                                    ...
                                    <asp:SqlDataSource ID="sqlTrangThaiHang" runat="server" ConnectionString="<%$ ConnectionStrings:BanHangConnectionString %>" SelectCommand="SELECT * FROM [GPM_TrangThaiHang] WHERE (([ID] &lt;&gt; @ID) AND ([ID] &lt;&gt; @ID2) AND ([ID] &lt;&gt; @ID3))">
                                        <SelectParameters>
                                            ...
                                            <asp:Parameter DefaultValue="6" Name="ID2" Type="Int32" />
                                            <asp:Parameter DefaultValue="7" Name="ID3" Type="Int32" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                ...
                <dx:LayoutGroup Caption="Thông tin thêm" ColCount="3" Visible="False">
                <Items>
                ...
                <dx:LayoutGroup Caption="Barcode">
                    <Items>
                ...
                <dx:LayoutGroup Caption="Giá theo số lượng">
                    <Items>
                        <dx:LayoutItem Caption="">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
