<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChiTietDonHangXuLy1PhanThuMua.aspx.cs" Inherits="BanHang.ChiTietDonHangXuLy1PhanThuMua" %>
...
<SettingsText Title="THÔNG TIN CHI TIẾT ĐƠN HÀNG CÒN LẠI" CommandDelete="Xóa" ConfirmDelete="Bạn chắc chắn muốn xóa?" CommandEdit="Sửa" EmptyDataRow="Danh sách hàng hóa trống" SearchPanelEditorNullText="Nhập thông tin cần tìm..."></SettingsText>
<Columns>
    ...
    <dx:GridViewDataSpinEditColumn Caption="Trọng Lượng" FieldName="TrongLuong" VisibleIndex="4" ReadOnly="True" Visible="False">
