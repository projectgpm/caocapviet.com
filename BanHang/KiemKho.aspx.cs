    ...
    public partial class KiemKho : System.Web.UI.Page
    {
        ...
        protected void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (db.Rows.Count > 0)
            {
                ...
                data = new dtKiemKho();
                data.CapNhatPhieuKiemKho(IDPhieuKiemKho, IDNguoiDung, NgayKiemKho, IDKho, GhiChu);
                foreach (DataRow dr in db.Rows)
                {
                    string IDHangHoa = dr["IDHangHoa"].ToString();
                    ...
                    data = new dtKiemKho();
                    data.ThemPhieuKiemKho(IDPhieuKiemKho, IDHangHoa, TonKho, ChenhLech, ThucTe, MaHang, IDDonViTinh, IDKe);
                }
                data = new dtKiemKho();
                data.XoaPhieuKiemKho_Temp_IDPhieuKiemKho(IDPhieuKiemKho);
                Response.Redirect("DanhSachKiemKho.aspx");
