...
namespace BanHang
{
    public partial class BaoCaoKhachHangTraHang : System.Web.UI.Page
    {
        ...
        protected void btnXemBaoCao_Click(object sender, EventArgs e)
        {
            ...
            popup.ContentUrl = "~/BaoCaoKhachHangTraHang_In.aspx?ngayBD=" + ngayBD + "&ngayKT=" + ngayKT + "&IDKhoNhap=" + IDKhoNhap + "&IDKhachHang=" + IDKhachHang;
