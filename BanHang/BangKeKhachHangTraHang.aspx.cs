...
namespace BanHang
{
    public partial class BangKeKhachHangTraHang : System.Web.UI.Page
    {
        ...
        protected void btnXemBaoCao_Click(object sender, EventArgs e)
        {
            ...
            popup.ContentUrl = "~/BangKeKhachHangTraHang_In.aspx?ngayBD=" + ngayBD + "&ngayKT=" + ngayKT + "&IDKhoNhap=" + IDKhoNhap + "&IDKhachHang=" + IDKhachHang;
