...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    ...
    <Items>
        <dx:LayoutGroup Caption="Thông Tin Kệ" ColCount="3" ColSpan="3" RowSpan="3">
            <Items>
                <dx:LayoutItem Caption="Kệ">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer1" runat="server">
                            <dx:ASPxComboBox ID="cmbKe" runat="server" DataSourceID="SqlDanhSachKe" TextField="TenKe" ValueField="ID" AutoPostBack="True" OnSelectedIndexChanged="cmbKe_SelectedIndexChanged"  Width="100%" DropDownWidth="600px" DropDownStyle="DropDownList" >
                                <Columns>
                ...
                <dx:LayoutItem Caption="Nhân Viên">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer4" runat="server">
                            <dx:ASPxTextBox ID="txtNhanVien" runat="server" Enabled="False">
                            </dx:ASPxTextBox>
                        </dx:LayoutItemNestedControlContainer>
                    </LayoutItemNestedControlCollection>
                </dx:LayoutItem>
                <dx:LayoutItem Caption="Trạng Thái">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer3" runat="server">
                            <dx:ASPxTextBox ID="txtTrangThai" runat="server" Enabled="False" Text="Phiếu tạm">
                            </dx:ASPxTextBox>
                        </dx:LayoutItemNestedControlContainer>
                    </LayoutItemNestedControlCollection>
                </dx:LayoutItem>
        ...
        <dx:LayoutGroup Caption="Hàng Hóa Trong Kệ" ColCount="3" ColSpan="3" RowSpan="3">
            <Items>
                    ...
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer10" runat="server">
                            <dx:ASPxComboBox ID="cmbHangHoa" runat="server" 
                                ...
                                ValueField="ID"
                                NullText="Vui lòng chọn hàng hóa.........." Enabled="False"
                                >
                                <Columns>
                ...
                <dx:LayoutItem Caption="">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer11" runat="server">
                           <dx:ASPxUploadControl ID="UploadFileExcel" runat="server" AllowedFileExtensions=".xls" Enabled="False" ></dx:ASPxUploadControl>
                        </dx:LayoutItemNestedControlContainer>
                    </LayoutItemNestedControlCollection>
                </dx:LayoutItem>
                <dx:LayoutItem Caption="">
                    <LayoutItemNestedControlCollection>
                        <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer12" runat="server">
                            <dx:ASPxButton ID="btnThem_Temp" runat="server" Text="Thêm" Enabled="False" OnClick="btnThem_Temp_Click">
                        ...
                        <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer15" runat="server">
                            ...
                            <dx:ASPxGridView ID="gridDanhSachHangHoa" runat="server" AutoGenerateColumns="False" KeyFieldName="ID" OnRowDeleting="gridDanhSachHangHoa_RowDeleting" Width="100%">
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataComboBoxColumn Caption="ĐVT" FieldName="IDonViTinh" ShowInCustomizationForm="True" VisibleIndex="5">
