...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    ...
    <dx:ASPxGridView ID="gridPhieuXuatTra" runat="server" AutoGenerateColumns="False" Width="100%" KeyFieldName="ID">
        ...
        <Columns>
            <dx:GridViewDataTextColumn Caption="Ghi Chú" VisibleIndex="5" FieldName="GhiChu">
            ...
            <dx:GridViewDataDateColumn Caption="Ngày Lập" VisibleIndex="3" FieldName="NgayLap">
                <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy">
                </PropertiesDateEdit>
            </dx:GridViewDataDateColumn>
            <dx:GridViewDataDateColumn Caption="Ngày Cập Nhật" VisibleIndex="6" FieldName="NgayCapNhat">
            ...
            <dx:GridViewDataSpinEditColumn Caption="Tổng Tiền" FieldName="TongTien" VisibleIndex="4">
                <PropertiesSpinEdit DisplayFormatString="{0:#,# VND}">
                </PropertiesSpinEdit>
            </dx:GridViewDataSpinEditColumn>
            <dx:GridViewDataComboBoxColumn Caption="Người Lập Phiếu" FieldName="IDNhanVien" VisibleIndex="2">
